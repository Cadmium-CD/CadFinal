...
int main(){
  ...
  string def_file = "/home/bttb/CAD/parser/src/main/ispd18_sample.input.def";
  string lef_file = "/home/bttb/CAD/parser/src/main/ispd18_sample.input.lef";
  string RG_file = "/home/bttb/CAD/parser/src/main/ispd18_sample.input.guide";
...
////////////////////////parser///////////////////////////////////////////////////
  ...
  //generate grid 
  generateGrid(&MT);
  //find apc bettwen pin shape and metal1
  genPinShapeAPC(&MT,*macro_db,*db);
  //find overlap
  findOverlap(&MT,panelRG->vertMap, panelRG->horizMap);
  //cout<<"aa"<<endl;

  
  printf("%s\n",db->trackArray.size());
  //printf("%s\n",db->trackArray[0].layer[0]);
  //printf("%s\n",db->trackArray[0].macro_name);
  //printf("%s\n",db->trackArray[0].layer[1]);
//////////////////////////algorithm///////////////////////////////////////
